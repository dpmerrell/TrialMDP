...
$(BUILD_DIR)/block_rar_opt.o: $(SRC_DIR)/block_rar_opt.cpp $(INCLUDE_DIR)/block_rar_table.h $(INCLUDE_DIR)/contingency_table.h $(INCLUDE_DIR)/state_result.h $(INCLUDE_DIR)/transition_iterator.h $(INCLUDE_DIR)/state_iterator.h
	$(CXX) $(CXXFLAGS) -c $(SRC_DIR)/block_rar_opt.cpp -o $@ 
